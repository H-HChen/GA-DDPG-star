...
def pose_bc_loss(pi, action_batch):
    """
    PM loss for behavior clone
    """
    pred_act_pt = control_points_from_rot_and_trans(pi[: :, 3:6], pi[: :, :3], device="cuda")
    gt_act_pt = control_points_from_rot_and_trans(action_batch[: :, 3:6], action_batch[: :, :3], device="cuda")
