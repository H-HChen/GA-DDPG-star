...
__C.RL_TRAIN.value_milestones = [20000, 40000, 60000, 80000, 120000]
__C.RL_TRAIN.policy_milestones = [20000, 40000, 60000, 80000, 120000]
...
__C.RL_TRAIN.save_epoch = [5000, 20000, 40000, 80000, 140000, 180000, 200000, 240000, 280000, 320000, 400000, 480000]
...
__C.RL_TRAIN.index_file = os.path.join(__C.EXPERIMENT_OBJ_INDEX_DIR, 'acronym_90.json')
__C.RL_TRAIN.max_num_pts = 20000
__C.RL_TRAIN.uniform_num_pts = 1024
__C.RL_TRAIN.use_expert_plan = False
__C.RL_TRAIN.use_acronym = True
